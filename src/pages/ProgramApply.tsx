...
const programDetails: Record<string, {
  ...
  MAYA: {
    name: "MAYA",
    fullName: "MAYA — Self Alignment Coaching",
    tagline: "ALIGN",
    description: "A self alignment coaching journey for people who are moving forward but feel something is fundamentally off — not broken, just misaligned.",
    icon: Heart,
    duration: "24-hour guided journey",
    format: "Online or In-Person",
    groupSize: "1:1 or small cohort",
    features: ["Identity clarity work", "Purpose alignment mapping", "Pattern-level coaching", "Certified Success369 facilitator"],
  },
  SARVAM: {
    name: "SARVAM",
